export const cognito = {
  ...
  clientSecret: process.env.COGNITO_CLIENT_SECRET || "2446k8gchpuctd11spq14disc7viqos7ht9a99k918saf8hgscq",
  userPoolId: process.env.NEXT_PUBLIC_COGNITO_USER_POOL_ID || "us-east-1_4ZTGQMA7B",
  region: process.env.NEXT_PUBLIC_COGNITO_REGION || "us-east-1",
  redirectSignIn: process.env.NEXT_PUBLIC_COGNITO_REDIRECT_URI || "/auth/callback",
  redirectSignOut: process.env.NEXT_PUBLIC_COGNITO_SIGN_OUT_URI || "/api/auth/logout",
